...
/**
 * Amazon SNS extended client configuration options such as Amazon S3 client,
...
public class ExtendedClientConfiguration {
    ...
    private int messageSizeThreshold = SNSExtendedClientConstants.DEFAULT_MESSAGE_SIZE_THRESHOLD;
